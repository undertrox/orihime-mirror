...
public class Camera {//実?ﾛの?ﾀ標と?A表示?ﾀ標の仲立ち
    ...
    */
    ...
    public void hyouji() {//各種パラ???[タを表示する
    ...
    //TV?繧ﾌ表示は変化しないようにして?ATV?繧ﾌ?ﾀ標Ten?@P?@に対応する?A被写体の位置にcamera位置をあわせる?B
